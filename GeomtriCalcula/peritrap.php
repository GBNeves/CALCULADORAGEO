  ...
  <div class="card-body">
    <h5 class="card-title">Perimetro do Trapezio</h5>
        <?php
         ...
         $valor3 = $_GET['valor3'];
         $valor4 = $_GET['valor4'];
         $a = $valor1 + $valor2 + $valor3 + $valor4 ;
        echo "$valor1 + $valor2 + $valor3 + $valor4 = $a<br>";
        echo "";
        ?>
        <p class="card-text">Assim você calcula o perimetro de um trapezio, somando todos os lados!</p>
    <p> </p>
