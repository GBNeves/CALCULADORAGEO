<html lang="en">
  ...
  <div class="card-body">
    <h5 class="card-title">Area do Circulo</h5>
    <?php
         $valor1 = $_GET['valor1'];
         $a = 3.14 * $valor1 * $valor1;
         echo "3,14 * $valor1 ² = $a";
         ?>
    <p class="card-text">Para calcular a area de um circulo você deve multiplicar o valor de PI pelo raio (metade do diametro) ao quadrado.</p>
    <p> </p>
